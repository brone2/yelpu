...
var restLocation = [NSMutableDictionary()]//[String:[NSNumber]]()
var temp_array = [NSNumber]()
var temp_dict = NSMutableDictionary() //[String: [Float]]()

public func restInRadius(phoneNumbers: [String]) {
...
/*
                        let restLong = formatDict[0]?["coordinates"]?["longitude"] as! Float
